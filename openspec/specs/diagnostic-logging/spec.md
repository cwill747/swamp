...
Describe swamp's diagnostic logging behavior: persistent per-repository daemon
log files, configurable log levels, worktree-tagged events, tab-addition and
git-refresh diagnostics, and the `swamp logs` inspection command.
